...
function deliveryInfo() {
  return { mailConfigured: isMailConfigured(), senderAddress: config.mail.from || null, emailProvider: config.mail.scriptUrl ? 'Gmail (relay script)' : 'Gmail SMTP', siteUrl: config.email.siteUrl, supportEmail: config.email.supportEmail };
}
